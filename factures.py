...
class FacturesWindow:
    def __init__(self, parent):
        ...
        self.window.title("Module Factures - Gestion Pharmacie")
        self.window.geometry("600x400")
        self.window.configure(bg="#f4f4f4")

        tk.Label(self.window, text="Page Factures",
                 font=("Arial", 20, "bold"), bg="#393FB8", fg="white").pack(fill='x', pady=10)

        tk.Label(self.window, text="Ici s'afficheront les factures enregistrées.",
